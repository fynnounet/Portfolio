  ...
  return (
    <div className="speed-lines">
      <svg viewBox="0 0 480 260" preserveAspectRatio="none">
        <line x1="480" y1="130" x2="340" y2="20" stroke="rgba(127,119,221,0.04)" strokeWidth="1" />
        <line x1="480" y1="130" x2="320" y2="10" stroke="rgba(127,119,221,0.03)" strokeWidth="1" />
        <line x1="480" y1="130" x2="300" y2="0" stroke="rgba(127,119,221,0.025)" strokeWidth="1" />
        <line x1="480" y1="130" x2="360" y2="0" stroke="rgba(127,119,221,0.035)" strokeWidth="1" />
        <line x1="480" y1="130" x2="260" y2="5" stroke="rgba(127,119,221,0.02)" strokeWidth="1" />
        <line x1="480" y1="130" x2="380" y2="260" stroke="rgba(127,119,221,0.04)" strokeWidth="1" />
        <line x1="480" y1="130" x2="340" y2="260" stroke="rgba(127,119,221,0.03)" strokeWidth="1" />
        <line x1="480" y1="130" x2="290" y2="250" stroke="rgba(127,119,221,0.025)" strokeWidth="1" />
        <line x1="480" y1="130" x2="250" y2="240" stroke="rgba(127,119,221,0.02)" strokeWidth="1" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="about-panel">
      <div className="char-portrait">
        <img
          src="https://img1.picmix.com/output/stamp/normal/4/4/5/4/604544_3dbbc.gif"
          alt="Haizea MAREMBERT"
          height="50px"
        />
      </div>
      <div>
  ...
  return (
    <footer className="footer" id="contact">
      ...
      <div className="footer-links">
        <a href="https://github.com/fynnounet" target="_blank" rel="noreferrer">
          GitHub
        </a>
        <a
          href="https://linkedin.com/in/fynnounet"
          target="_blank"
          rel="noreferrer"
        >
          LinkedIn
